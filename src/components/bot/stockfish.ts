...
import {StockfishQueryParams, ChessMove, StockfishResponse, ComputerConfiguration, stockfishLevels } from '@/types/bot';
...
export class StockFish {
  ...
  public async getBestMove(fen: string): Promise<ChessMove> {
    const queryParams: StockfishQueryParams = {
      fen,
      depth: stockfishLevels[this.computerConfiguration.level],
    }
